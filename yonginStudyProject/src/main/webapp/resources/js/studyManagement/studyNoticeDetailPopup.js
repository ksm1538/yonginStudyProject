...
$(document).ready(function () {
	...
	studyNoticeInfoDetailBinder.setModel({}, $(document["noticeInfoDetailForm"]));
	
	selectStudyNoticeInfoDetail(parentData.boardCode);
...
function selectStudyNoticeInfoDetail(boardCode){
	...
	$.ajax({
 		type: "POST",
 		url : "/studyManagement/selectStudyNoticeInfoDetail.json",
 		data : boardCode,
		...
		btns:{
			yes: {
				label:'네', onClick:function(key){
					...
					$.ajax({
					     type: "POST",
					     url : "/studyManagement/studyNoticeDelete.json",
