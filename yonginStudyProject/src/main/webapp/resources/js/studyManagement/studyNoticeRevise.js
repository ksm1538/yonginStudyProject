...
$(document).ready(function () {
	...
	studyNoticeInfoDetailBinder.setModel({}, $(document["reviseNoticeForm"]));
...
// 부모 페이지에서 받은 boardCode를 이용해 스터디 공지사항 조회
function reviseStudyNotice(boardCode){
	...
	$.ajax({
 		type: "POST",
 		url : "/studyManagement/selectStudyNoticeRevise.json",
 		data : boardCode,
...
function reviseStudyNoticeFunc(){
    ...
    $.ajax({
        ...
        url: "/studyManagement/studyNoticeRevise",
        data: data,
