...
<script type="text/javascript" src="/resources/js/studyManagement/studyFreeNoticeRevise.js"></script>
...
<body>
	...
	<div class="col-12 notice_revise_wrap">
		<div class="col-12 notice_revise_con">
			...
			<div class="tc notice_revise_title"><span>자유게시판 수정</span></div>
		</div>
	</div>
		...
		<form name="reviseNoticeForm" id="reviseNoticeForm" method="POST" enctype="multipart/form-data">
		 ...
		 <div class="study_detail_pop_wrap_con" id="detailDiv">
				...
				<div class="btn_style_1_con">
					<input type="button" value="수정완료" class="btn_style_1" onclick="reviseStudyFreeNoticeFunc()" >
