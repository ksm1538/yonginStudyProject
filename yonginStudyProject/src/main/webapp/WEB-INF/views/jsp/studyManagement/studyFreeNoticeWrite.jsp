...
<script type="text/javascript" src="/resources/js/studyManagement/studyFreeNoticeWrite.js"></script>
...
<div class="col-12 col-center mw-1200 make_study_wrap">
   ...
   <div class="tc make_study_title_con">
      <div class="make_study_title">자유게시판 작성</div>
   </div> 
   ...
   <div class="col-12 col-center mw-1200 make_study_form_wrap">
      <div class="make_study_form_con">
      	<div class="study_text make_study_form">
           ...
           <div class="make_study_input_con">
           	 <div class="write_free_notice_name_wrap"><input type="text" name="boardTitle" id="boardTitle" class="name_textbox_style_0"></div>
           </div>
	...
	<div class="col-12 col-center mw-1200 write_notice_btn_wrap">
   		<div class="btn_style_1_con">
      		<input type="button" value="작성하기" class="btn_style_1" onclick="studyFreeNoticeWriteFunc()">
