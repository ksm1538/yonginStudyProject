...
<script type="text/javascript" src="/resources/js/studyManagement/reviseStudyNotice.js"></script>
...
<body>
	<div class="col-12 studynotice_revise_wrap">
		<div class="col-12 studynotice_revise_con">
			<div class="circle_btn" onClick="closeModal()"></div> 
			<div class="tc studynotice_revise_title"><span>공지사항 수정</span></div>
		</div>
	</div>
	<div class="col-12 studynotice_detail_pop_content_con">
		...
		<form name="reviseStudyNoticeForm" id="reviseStudyNoticeForm" method="POST" enctype="multipart/form-data">
		 <input type="hidden" id="fileCodeDel" name="fileCodeDel" value=""> 
		 <input type="hidden" id="boardCode" name="boardCode" value=""> 
		 
		 <div class="studynotice_detail_pop_wrap_con" id="studydetailDiv">
				
			<div class="studynotice_revise_name_wrap">	
