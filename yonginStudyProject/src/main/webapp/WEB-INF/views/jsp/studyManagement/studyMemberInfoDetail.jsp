...
<script type="text/javascript" src="/resources/js/studyManagement/studyMemberInfoDetail.js"></script>
...
<body>
	...
	<div class="col-12 col-center mw-1200 study_member_detail_info_wrap">
		<form:form method="POST" modelAttribute="userInfoVO" name="studyMemberInfoDetailForm" id="studyMemberInfoDetailForm" >
		<div id=detailDiv>
