...
<script src="<c:url value="/resources/util/calender.js" />"></script>
                ...
                <div class="col-12 calender_wrap content_wrap">
                    ...
                    <div class="calender_con">
                        <div class="col-12 tc calender_month_con">
                            <div class="left_arrow_con"><a href="#" id="prev_month"><img src="../../IMG/arrow.png" class="left_arrow"></a></div>
                            <div class="month_choice">
                                <span class="choice_year" id="choice_year"></span>
                                <span class="choice_month" id="choice_month"></span>
                            </div>
                            <div class="right_arrow_con"><a href="#" id="next_month"><img src="../../IMG/arrow.png" class="right_arrow"></a></div>
                        </div>
                    </div>
